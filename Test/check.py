...
def run_tests():
    ...
    test_output_vs_expected("graph" , "../inputs/input6.txt" , "../outputs/output6.txt")
    
    test_memory("graph" , "../inputs/input1.txt" )
    test_memory("graph" , "../inputs/input2.txt" )
    test_memory("graph" , "../inputs/input3.txt" )
    test_memory("graph" , "../inputs/input4.txt" )
    test_memory("graph" , "../inputs/input5.txt" )
    test_memory("graph" , "../inputs/input6.txt" )
    
    subprocess.run("rm -rf ../Graph-DataStructure", shell=True)
